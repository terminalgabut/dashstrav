 ...
 * Versi Full - Terintegrasi dengan Walk Category
 */
...
export default { 
    ...
    methods: { 
        ...
        updateYearlyData() {
            // Filter aktivitas berdasarkan tahun yang dipilih
            const yearActivities = this.allActivities.filter(a => new Date(a.start_date).getFullYear() === this.selectedYear);
            
            // Kalkulasi statistik tiap jenis olahraga menggunakan Service
        ...
        initYearlyChart(activities) {
            ...
            // Mendapatkan config chart dari Service
